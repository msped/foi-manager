...
class TestPublicationSchemeEntry:
    ...
    def test_ordering_by_category_then_title(self, db, foi_team_user):
        PublicationSchemeEntry.objects.create(
            title='Z entry', category=PublicationSchemeEntry.Category.FINANCES, created_by=foi_team_user
        )
        PublicationSchemeEntry.objects.create(
            title='A entry', category=PublicationSchemeEntry.Category.FINANCES, created_by=foi_team_user
        )
