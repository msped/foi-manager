...
class UserListView(generics.ListAPIView):
    ...
    def get_queryset(self):
        return User.objects.filter(role=User.Role.FOI_TEAM).order_by(
    ...
    def get_queryset(self):
        ...
        if search:
            qs = (
                ...
                | User.objects.filter(is_active=True, last_name__icontains=search)
                | User.objects.filter(is_active=True, email__icontains=search)
            )
